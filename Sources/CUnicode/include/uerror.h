 ...
 * @stable ICU 2.0
 */
typedef CF_ENUM(int, UErrorCode) {
    ...
    U_INVARIANT_CONVERSION_ERROR = 26,  /**< Unable to convert a uint16_t* string to char* with the invariant converter. */
 ...
 * @stable ICU 2.0
 */
static inline U_SWIFT_NAME(getter:UErrorCode.isSuccess(self:))
_Bool U_SUCCESS(UErrorCode code) { return code <= U_ZERO_ERROR; }
/**
 * Does the error code indicate a failure?
 * @stable ICU 2.0
 */
static inline U_SWIFT_NAME(getter:UErrorCode.isFailure(self:))
_Bool U_FAILURE(UErrorCode code) { return code > U_ZERO_ERROR; }
 ...
 * @stable ICU 2.0
 */
extern const char *u_errorName(UErrorCode code);
