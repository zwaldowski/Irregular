...
#ifndef U_SWIFT_NAME
#define U_SWIFT_NAME(_name) __attribute__((swift_name(#_name)))
#endif
...
/**
  ...
  * @stable ICU 3.4
  */
extern U_SWIFT_NAME(UText.close(self:))
UText *
 ...
 * @stable ICU 3.4
 */
extern UText *_Nullable
utext_openUTF8(UText *_Nullable ut, const char *s, int64_t length, UErrorCode *status);
 ...
 */
extern UText *_Nullable
utext_openUChars(UText *_Nullable ut, const uint16_t *s, int64_t length, UErrorCode *status);
...
/**
  ...
  *  @stable ICU 3.4
  */
extern U_SWIFT_NAME(UText.clone(to:self:isDeep:isReadOnly:status:))
UText *_Nullable
utext_clone(UText *_Nullable dest, const UText *src, int8_t deep, int8_t readOnly, UErrorCode *status);
...
/**
  ...
  */
extern int8_t
utext_equals(const UText *_Nullable a, const UText *_Nullable b);
...
/**
  ...
  * @stable ICU 3.4
  */
extern U_SWIFT_NAME(getter:UText.nativeLength(self:))
int64_t
...
/**
  ...
  * @stable ICU 3.4
  */
extern U_SWIFT_NAME(getter:UText.nativeIndex(self:))
int64_t
 ...
 * @stable ICU 3.4
 */
extern U_SWIFT_NAME(setter:UText.nativeIndex(self:_:))
void
 ...
 * @stable ICU 3.6
 */
extern U_SWIFT_NAME(getter:UText.previousNativeIndex(self:))
int64_t
utext_getPreviousNativeIndex(UText *const ut);
 ...
 * @stable ICU 3.4
 */
extern U_SWIFT_NAME(UText.extract(self:fromOffset:toOffset:to:capacity:status:))
int32_t
utext_extract(UText *ut,
             int64_t nativeStart, int64_t nativeLimit,
             uint16_t *dest, int32_t destCapacity,
             UErrorCode *status);
 ...
 *
 */
extern U_SWIFT_NAME(getter:UText.isWritable(self:))
int8_t
...
/**
  ...
  * @stable ICU 3.4
  */
extern U_SWIFT_NAME(getter:UText.hasMetaData(self:))
int8_t
 ...
 * @stable ICU 3.4
 */
extern U_SWIFT_NAME(UText.replaceRange(self:fromOffset:toOffset:with:length:status:))
int32_t
utext_replace(UText *ut,
             int64_t nativeStart, int64_t nativeLimit,
             const uint16_t *replacementText, int32_t replacementLength,
             UErrorCode *status);
 ...
 * @stable ICU 3.4
 */
extern U_SWIFT_NAME(UText.copySubstring(self:fromOffset:toOffset:toIndex:shouldMove:status))
void
utext_copy(UText *ut,
          int64_t nativeStart, int64_t nativeLimit,
          int64_t destIndex,
...
/**
  ...
  *  @stable ICU 3.6
  */
extern U_SWIFT_NAME(UText.freeze(self:))
void
 ...
 * @stable ICU 3.4
 */
typedef U_SWIFT_NAME(UText.UTextProviderProperties) CF_OPTIONS(int32_t, UTextProviderProperties) {
    /**
     * It is potentially time consuming for the provider to determine the length of the text.
     * @stable ICU 3.4
     */
    UTEXT_PROVIDER_LENGTH_IS_EXPENSIVE U_SWIFT_NAME(lengthIsExpensive) = 1,
    /**
     ...
     * @stable ICU 3.4
     */
    UTEXT_PROVIDER_STABLE_CHUNKS U_SWIFT_NAME(stableChunks) = 2,
    /**
     ...
     * @stable ICU 3.4
     */
    UTEXT_PROVIDER_WRITABLE U_SWIFT_NAME(writable) = 3,
    /**
     * There is meta data associated with the text.
     * @see Replaceable::hasMetaData()
     * @stable ICU 3.4
     */ 
    UTEXT_PROVIDER_HAS_META_DATA U_SWIFT_NAME(hasMetaData) = 4,
    /**
     ...
     * @stable ICU 3.6
     */
     UTEXT_PROVIDER_OWNS_TEXT U_SWIFT_NAME(ownsText) = 5
};
...
/**
  ...
  * @stable ICU 3.4
  */
typedef U_SWIFT_NAME(UText.CloneCallback) UText *_Nullable
UTextClone(UText *_Nullable dest, const UText *src, int8_t deep, UErrorCode *status);
 ...
 * @stable ICU 3.4
 */
typedef U_SWIFT_NAME(UText.NativeLengthCallback)int64_t
 ...
 * @stable ICU 3.4
 */
typedef U_SWIFT_NAME(UText.AccessCallback) int8_t
UTextAccess(UText *ut, int64_t nativeIndex, int8_t forward);
 ...
 * @stable ICU 3.4
 */
typedef U_SWIFT_NAME(UText.ExtractCallback) int32_t
 ...
 * @stable ICU 3.4
 */
typedef U_SWIFT_NAME(UText.ReplaceCallback) int32_t
UTextReplace(UText *ut,
             int64_t nativeStart, int64_t nativeLimit,
             const uint16_t *replacementText, int32_t replacmentLength,
             UErrorCode *status);
 ...
 * @stable ICU 3.4
 */
typedef U_SWIFT_NAME(UText.CopyCallback) void
UTextCopy(UText *ut,
          int64_t nativeStart, int64_t nativeLimit,
          int64_t nativeDest,
          int8_t move,
 ...
 * @stable ICU 3.4
 */
typedef U_SWIFT_NAME(UText.MapOffsetToNativeCallback) int64_t
 ...
 * @stable ICU 3.4
 */
typedef U_SWIFT_NAME(UText.MapNativeIndexToUTF16Callback) int32_t
 ...
 * @stable ICU 3.4
 */
typedef U_SWIFT_NAME(UText.CloseCallback) void
UTextClose(UText *ut);
...
struct UTextFuncs {
     ...
     * @stable ICU 3.6
     */
    UTextNativeLength *_Nullable nativeLength;
     ...
     * @stable ICU 3.6
     */
    UTextExtract *_Nullable extract;
     ...
     * @stable ICU 3.6
     */
    UTextReplace *_Nullable replace;
     ...
     * @stable ICU 3.6
     */
    UTextMapOffsetToNative *_Nullable mapOffsetToNative;
     ...
     * @stable ICU 3.6
     */
    UTextMapNativeIndexToUTF16 *_Nullable mapNativeIndexToUTF16;
     ...
     * (public) Function pointer for UTextClose.
      ...
      * @stable ICU 3.6
      */
    UTextClose  *_Nullable close;

    /**
      * (private)  Spare function pointer
      * @internal
      */
    UTextClose  *_Nullable spare1;
    
    /**
      * (private)  Spare function pointer
      * @internal
      */
    UTextClose  *_Nullable spare2;

    /**
      * (private)  Spare function pointer
      * @internal
      */
    UTextClose  *_Nullable spare3;
...
struct UText {
    ...
    /**
      ...
      *  @stable ICU 3.4
      */
    UTextProviderProperties providerProperties;
     ...
     *  @stable ICU 3.6
     */
    const uint16_t *_Nullable chunkContents;

     /**
      * (public)     Pointer to Dispatch table for accessing functions for this UText.
      * @stable ICU 3.6
      */
    const UTextFuncs *_Nullable pFuncs;
     ...
     * @stable ICU 3.6
     */
    const void     *_Nullable p;
    /**
     * (protected) Pointer fields available for use by the text provider.
     * Not used by UText common code.
     * @stable ICU 3.6
     */
    const void     *_Nullable q;
     /**
     * (protected) Pointer fields available for use by the text provider.
     * Not used by UText common code.
     * @stable ICU 3.6
      */
    const void     *_Nullable r;
 ...
 *  If the supplied UText is already open, the pxrovider's close function will be called
 ...
 * @stable ICU 3.4
 */
extern U_SWIFT_NAME(UText.setup(_:extraSpace:status:))
UText *_Nullable
utext_setup(UText *_Nullable ut, int32_t extraSpace, UErrorCode *status);

static inline U_SWIFT_NAME(UText.init(vtable:context:))
UText utext_make(UTextFuncs *const vtable, void *context) {
    return (UText){
          0x345ad82c,           /* magic                */
          0,                    /* flags                */
          0,                    /* providerProps        */
